<tool_call:default_api:codeGenerate{language:tsx,prompt:Gere o código para o arquivo src/routes/index.tsx:import { createFileRoute } from '@tanstack/react-router'export const Route = createFileRoute('/')({
component: Index,
})function Index() {
return (
<div style={{
